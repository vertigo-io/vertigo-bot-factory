...
public final class IncomeRating {
	...
	private IncomeRating(final UUID convUUID, final Integer note, final String comment, final Boolean isSatisfied) {
	...
	public IncomeRating of(final UUID convUUID, final Integer note, final String comment, final Boolean isSatisfied) {
		Assertion.check().isNotNull(note);
		return new IncomeRating(convUUID, note, comment, isSatisfied);
	}
