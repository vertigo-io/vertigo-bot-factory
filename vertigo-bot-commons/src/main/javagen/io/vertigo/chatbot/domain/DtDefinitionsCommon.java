 ...
 */
@Generated
public final class DtDefinitionsCommon implements Iterable<Class<?>> {
	...
	public enum Definitions {
		...
		IntentExport(io.vertigo.chatbot.commons.domain.IntentExport.class),
	 ...
	 */
	public enum IntentExportFields implements DtFieldName<io.vertigo.chatbot.commons.domain.IntentExport> {
		/** Propriété 'intent'. */
		intent,
