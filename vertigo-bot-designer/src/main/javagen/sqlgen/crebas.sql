...
drop table IF EXISTS GLOBAL_VARIABLE cascade;
drop sequence IF EXISTS SEQ_GLOBAL_VARIABLE;
drop table IF EXISTS GLOBAL_VARIABLE_TYPE cascade;
drop sequence IF EXISTS SEQ_GLOBAL_VARIABLE_TYPE;
...
create sequence SEQ_GLOBAL_VARIABLE
	start with 1000 cache 1; 

create sequence SEQ_GLOBAL_VARIABLE_TYPE
	start with 1000 cache 1; 
