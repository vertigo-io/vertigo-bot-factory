...
public final class ScriptIntentionPAO implements StoreServices {
	...
	*/
	...
	public io.vertigo.datamodel.data.model.DtList<io.vertigo.chatbot.commons.domain.topic.ScriptIntentionIhm> getScriptIntentionIHMByBot(@io.vertigo.datamodel.task.proxy.TaskInput(name = "botId", smartType = "STyId") final Long botId) {
