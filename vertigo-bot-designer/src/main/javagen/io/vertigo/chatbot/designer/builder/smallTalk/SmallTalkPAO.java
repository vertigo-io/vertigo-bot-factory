...
public final class SmallTalkPAO implements StoreServices {
	...
	*/
	...
	public io.vertigo.datamodel.data.model.DtList<io.vertigo.chatbot.commons.domain.topic.SmallTalkIhm> getSmallTalkIHMByBot(@io.vertigo.datamodel.task.proxy.TaskInput(name = "botId", smartType = "STyId") final Long botId) {
