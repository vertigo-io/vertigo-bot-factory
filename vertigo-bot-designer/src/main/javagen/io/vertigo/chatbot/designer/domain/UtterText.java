...
public final class UtterText implements Entity {
	...
	@io.vertigo.dynamo.domain.stereotype.Association(
			...
			foreignLabel = "UtterText",
			foreignMultiplicity = "0..*")
	private final VAccessor<io.vertigo.chatbot.designer.domain.Action> actIdAccessor = new VAccessor<>(io.vertigo.chatbot.designer.domain.Action.class, "Action");
	 ...
	 */
	public VAccessor<io.vertigo.chatbot.designer.domain.Action> action() {
