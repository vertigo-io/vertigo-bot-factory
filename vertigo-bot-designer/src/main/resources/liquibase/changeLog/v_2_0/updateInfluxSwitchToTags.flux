...
pivot
|> drop(columns: ["confidence", "duration", "inner_duration", "subprocesses"])
#TO#

pivot
|> set(key: "_field", value:"confidence" )
|> drop(columns: ["_value", "duration", "inner_duration", "subprocesses"])
|> rename(columns: {confidence: "_value"})
|> toFloat()
#TO#
