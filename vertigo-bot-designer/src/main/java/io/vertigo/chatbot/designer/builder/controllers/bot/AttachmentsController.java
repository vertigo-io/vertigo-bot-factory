...
public class AttachmentsController extends AbstractBotListEntityController<Attachment> {
	...
	public void initContext(final ViewContext viewContext, final UiMessageStack uiMessageStack, @PathVariable("botId") final Long botId) {
		...
		DtList<Attachment> attachments = attachmentServices.findAllByBotId(botId);
	...
	public ViewContext saveAttachment(final ViewContext viewContext,
		...
		Attachment attachment = attId.isEmpty() ? new Attachment() : attachmentServices.findById(attId.get());
		...
		DtList<Attachment> attachments = attachmentServices.findAllByBotId(bot.getBotId());
		viewContext.publishDtList(attachmentsKey, attachments);
		viewContext.publishRef(attachmentTotalSizeKey, computeAttachmentTotalSize(attachments));
		return viewContext;
	}
	...
	private Long computeAttachmentTotalSize(DtList<Attachment> attachments) {
