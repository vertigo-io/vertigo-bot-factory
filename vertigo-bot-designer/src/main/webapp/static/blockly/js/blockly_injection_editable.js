...
injectionBlockly_editable()

function injectionBlockly_editable(){
        // blocklyArea = document.getElementById('blocklyArea');
        blocklyDiv = document.getElementById('blocklyDiv');
        // console.log("injectionBlockly_editable() from blockly_injection_editable")
        // console.log(workspace)
        // blocklyDiv = null;
        document.getElementById('blocklyDiv').innerHTML = null
...
// workspace.addChangeListener(fromCode);
// console.log(VertigoUi.vueData)
// console.log(VUiExtensions.dataX)
