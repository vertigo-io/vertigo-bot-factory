...
public final class RuntimeTypeAdapterFactory<T> implements TypeAdapterFactory {
	...
	private RuntimeTypeAdapterFactory(final Class<?> baseType, final String typeFieldName, final boolean maintainType) {
	...
	public <R> TypeAdapter<R> create(final Gson gson, final TypeToken<R> type) {
		...
		return new TypeAdapter<R>() {
			@Override public R read(final JsonReader in) throws IOException {
			...
			@Override public void write(final JsonWriter out, final R value) throws IOException {
