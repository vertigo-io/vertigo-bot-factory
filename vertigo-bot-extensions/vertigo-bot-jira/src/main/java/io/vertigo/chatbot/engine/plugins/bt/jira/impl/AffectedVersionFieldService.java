...
public class AffectedVersionFieldService implements IJiraFieldService, Component {
	...
	public boolean supports(String fieldKey) {
		return IssueFieldId.AFFECTS_VERSIONS_FIELD.id.equals(fieldKey);
	}
	...
	public void processTicket(BlackBoard bb, IssueInputBuilder iib, JiraField jiraField) {
		iib.setAffectedVersionsNames(List.of(jiraField.getValue()));
	}
